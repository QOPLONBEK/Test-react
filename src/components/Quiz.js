        ...
        return (
            <div>
                ...
                {(this.props.mode !== 'submit') &&
                    <div>
                        <hr />
                        <button id="quiz" className="btn btn-outline-success border-0" onClick={this.setMode}>Viktorina</button>
                        <button id="review" className="btn btn-outline-success border-0" onClick={this.setMode}>Ko‘rib chiqish</button>
                        <button id="submit" className="btn btn-success border-0 bg-transporent" onClick={this.setMode}>Viktorinani topshirish</button >
                    </div >}
            </div>
        )
    }
