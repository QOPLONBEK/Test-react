    ...
    return (
      <div className="container">
        <header className="p-2">
          <div className="row">
            <div className="col-6">
              <h3 className='text-primary'>Viktorina uchun ariza</h3>
            </div>
            <div className="col-6 text-right text-primary">
              <label className="mr-2 mt-2 text-success">Viktorinani tanlang:</label>
              <select className='text-success' onChange={this.onChange}>
